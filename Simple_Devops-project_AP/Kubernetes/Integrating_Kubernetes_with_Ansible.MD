...
1. Create ansible playbooks to create **[deployment](https://github.com/apatra/Simple-DevOps-Project/blob/main/Kubernetes/kubernetes-valaxy-deployment.yml)** and **[services](https://github.com/apatra/Simple-DevOps-Project/blob//Kubernetes/kubernetes-valaxy-service.yml)** 
